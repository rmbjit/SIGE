...
$protected = [
    ...
    'includes/operational-workflow-hardening.php' => '0f1a855af7ce37009fd5e2decc263d8a47ccca534e8edd5b319a44d8d7515114',
];
...
$src = (string) file_get_contents($root . '/includes/profile-dashboard-intelligence.php');
foreach (['update_option','add_option','delete_option','wp_insert_post','wp_delete_post','ALTER TABLE','CREATE TABLE','DROP TABLE','INSERT INTO','DELETE FROM','UPDATE '] as $needle) {
    if (stripos($src, $needle) !== false) $errors[] = 'hotfix de copy introduziu escrita proibida: ' . $needle;
}
...
echo "v12.19.1 NO SENSITIVE REGRESSION OK - apenas copy/UX textual do dashboard foi alterada; módulos sensíveis preservados.
";
