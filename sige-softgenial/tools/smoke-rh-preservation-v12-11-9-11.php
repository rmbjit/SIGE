...
/**
 * SIGE SoftGenial v12.11.9.11 - Smoke preservação RH / Arquivo de Removidos
 * Executar fora do WordPress: php tools/smoke-rh-preservation-v12-11-9-11.php
 */
...
echo "OK - smoke preservação RH v12.11.9.11 concluído sem falhas.\n";
exit(0);
