...
$checks = [
    'version_12_11_9_66' => strpos($main, 'Version: 12.11.9.66') !== false && strpos($main, "define('SIGE_VERSION', '12.11.9.66');") !== false,
...
if ($failed) {
    fwrite(STDERR, 'Smoke regressão Guarda/Portaria v12.11.9.66 falhou: ' . implode(', ', $failed) . PHP_EOL);
    exit(1);
}
echo 'Smoke regressão Guarda/Portaria v12.11.9.66 OK: ' . count($checks) . '/' . count($checks) . ' checks.' . PHP_EOL;
