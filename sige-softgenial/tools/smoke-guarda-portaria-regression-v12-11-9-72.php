...
/** Smoke regression v12.11.9.72 - Guarda/Portaria preservado após hotfix Portaria Camera Permission UX. */
...
if ($failed) { fwrite(STDERR, 'Smoke Guarda/Portaria regressão v12.11.9.72 falhou: ' . implode(', ', $failed) . PHP_EOL); exit(1); }
echo 'Smoke Guarda/Portaria regressão v12.11.9.72 OK: ' . count($checks) . '/' . count($checks) . ' checks.' . PHP_EOL;
