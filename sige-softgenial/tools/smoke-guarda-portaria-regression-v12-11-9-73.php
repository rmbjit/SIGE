...
/** Smoke regression v12.11.9.73 - Guarda/Portaria preservado após hotfix Portaria Camera Diagnostics. */
...
if ($failed) { fwrite(STDERR, 'Smoke Guarda/Portaria regressão v12.11.9.73 falhou: ' . implode(', ', $failed) . PHP_EOL); exit(1); }
echo 'Smoke Guarda/Portaria regressão v12.11.9.73 OK: ' . count($checks) . '/' . count($checks) . ' checks.' . PHP_EOL;
