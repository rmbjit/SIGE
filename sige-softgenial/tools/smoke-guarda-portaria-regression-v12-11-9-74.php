...
/** Smoke regression v12.11.9.74 - Guarda/Portaria preservado após hotfix Portaria Edge/Permissions-Policy Camera Hotfix. */
...
if ($failed) { fwrite(STDERR, 'Smoke Guarda/Portaria regressão v12.11.9.74 falhou: ' . implode(', ', $failed) . PHP_EOL); exit(1); }
echo 'Smoke Guarda/Portaria regressão v12.11.9.74 OK: ' . count($checks) . '/' . count($checks) . ' checks.' . PHP_EOL;
