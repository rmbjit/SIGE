...
/** Smoke regressão Guarda/Portaria para v12.11.9.69. */
...
$checks = [
    'version_12_11_9_69' => strpos($main, 'Version: 12.11.9.69') !== false && strpos($main, "SIGE_VERSION', '12.11.9.69'") !== false,
...
if ($failed) { fwrite(STDERR, 'Smoke Guarda v12.11.9.69 falhou: ' . implode(', ', $failed) . PHP_EOL); exit(1); }
echo 'Smoke Guarda/Portaria v12.11.9.69 OK: ' . count($checks) . '/' . count($checks) . ' checks.' . PHP_EOL;
