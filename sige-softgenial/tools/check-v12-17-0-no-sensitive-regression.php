...
foreach (['includes/alunos-performance-contract.php','includes/aluno-fetch-ajax.php'] as $include) {
    if (strpos($main, $include) === false) $errors[] = 'include esperado ausente: ' . $include;
}
...
echo "v12.17.0 NO SENSITIVE REGRESSION OK - financeiro, academico, permissoes e shell preservados.\n";
