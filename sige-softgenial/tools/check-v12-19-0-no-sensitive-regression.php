...
if (version_compare($currentVersion, '12.19.0', '<')) $errors[] = 'SIGE_VERSION inferior a 12.19.0.';
if (strpos($main, 'includes/profile-dashboard-intelligence.php') === false) $errors[] = 'include v12.19.0 ausente do bootstrap.';
$build = json_decode((string) file_get_contents($root . '/BUILD.json'), true);
if (!is_array($build) || version_compare((string)($build['version'] ?? '0'), '12.19.0', '<')) $errors[] = 'BUILD.json inferior a 12.19.0.';
...
echo "v12.19.0 NO SENSITIVE REGRESSION OK - financeiro, academico, permissoes, portaria, Alunos, dashboard core, shell e v12.18.0 preservados.\n";
