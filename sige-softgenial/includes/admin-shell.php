    ...
    <div id="sige-layout" class="sg-app-shell sg-product-pro-shell">
        ...
        <aside id="sige-sidebar" class="sg-app-sidebar" style="--sg-school-primary: <?php echo esc_attr($escola->cor_primaria ?: 'var(--sg-theme-primary-800,#3b2f8d)'); ?>;">
            ...
            <nav class="sg-app-nav">
                <?php
                // v12.20.0 - Barra lateral reordenada pelo fluxo do ano lectivo:
                // preparar -> matricular -> cobrar -> ensinar -> avaliar -> operar ->
                // acompanhar -> suporte. Cada item mantem a guarda igual ao mapa de rota.
                $sg_fin_on    = $ff_financeiro && $mod_financeiro_ativo;
                $sg_fin_mpesa = $sg_fin_on && function_exists('sige_mpesa_pode_gerir') && sige_mpesa_pode_gerir();
                $sg_fin_aprov = $sg_fin_on && function_exists('sige_fin_aprovacao_pode_aceder') && sige_fin_aprovacao_pode_aceder();
                $sg_beta = ' <span style="margin-left:auto;font-size:9px;font-weight:900;background:rgba(255,255,255,.16);padding:2px 6px;border-radius:var(--radius-pill);">BETA</span>';
                ?>
                ...
                <!-- 1. ESTRUTURA ACADÉMICA (preparar o ano) -->
                <?php if (empty($sige_scoped_professor) && $ff_academico && $sige_menu_can_any(['academico.disciplinas_ver','academico.matriz_ver','academico.reabrir_ano','academico.fechar_ano','configuracoes.ver'])): ?>
                    <div class="menu-label">ESTRUTURA ACADÉMICA</div>
                    <?php if ($sige_menu_can_any(['academico.reabrir_ano'])): ?><a href="?page=sige-app&view=abertura" class="sige-menu-item <?php echo $view == 'abertura' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/></svg> Abertura de Ano</a><?php endif; ?>
                    ...
                    <?php if ($sige_menu_can_any(['academico.matriz_ver','configuracoes.ver'])): ?><a href="?page=sige-app&view=curriculos" class="sige-menu-item <?php echo $view === 'curriculos' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><path d="M8 6h8"/><path d="M8 10h8"/></svg> Currículos<?php echo $sg_beta; ?></a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['academico.fechar_ano'])): ?><a href="?page=sige-app&view=encerramento" class="sige-menu-item <?php echo $view == 'encerramento' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg> Encerramento de Ano</a><?php endif; ?>
                <?php endif; ?>

                <!-- 2. EQUIPA (RH) -->
                <?php if ($ff_rh && $sige_menu_can_any((array)($sige_view_permission_map['equipe'] ?? []))): ?>
                    <div class="menu-label">EQUIPA</div>
                ...
                <!-- 3. SECRETARIA (matricular) - cadastro com casa estavel -->
                <?php if (empty($sige_scoped_professor) && $ff_cadastro && $sige_menu_can_any(['alunos.ver','academico.turmas_ver','alunos.contas_ver'])): ?>
                    <div class="menu-label">SECRETARIA</div>
                ...
                <!-- 4. FATURAÇÃO (cobrar: gerar) -->
                <?php if ($sg_fin_on && $sige_menu_can_any(['financeiro.lancar_mensalidades','financeiro.lancamentos_ver','financeiro.lancamentos_gerir','financeiro.planos_ver','financeiro.planos_gerir'])): ?>
                    <div class="menu-label">FATURAÇÃO</div>
                    <?php if ($sige_menu_can_any(['financeiro.lancar_mensalidades'])): ?><a href="?page=sige-app&view=financeiro-gerador" class="sige-menu-item <?php echo $view == 'financeiro-gerador' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="M12 15l-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/></svg> Lançar Mensalidades</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['financeiro.lancamentos_ver'])): ?><a href="?page=sige-app&view=financeiro-lancamentos" class="sige-menu-item <?php echo $view == 'financeiro-lancamentos' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg> Lançamentos</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['financeiro.lancamentos_gerir','financeiro.lancar_mensalidades'])): ?><a href="?page=sige-app&view=financeiro-inscricoes" class="sige-menu-item <?php echo $view == 'financeiro-inscricoes' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M9 15l2 2 4-4"/></svg> Inscrições e Renovações</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['financeiro.planos_ver','financeiro.planos_gerir'])): ?><a href="?page=sige-app&view=financeiro-planos" class="sige-menu-item <?php echo $view == 'financeiro-planos' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M9 11h6"/><path d="M9 15h6"/><path d="M9 7h6"/><rect x="5" y="3" width="14" height="18" rx="2"/></svg> Planos de Pagamento</a><?php endif; ?>
                <?php endif; ?>

                <!-- 5. TESOURARIA (cobrar: receber) -->
                <?php if ($sg_fin_on && ($sige_menu_can_any(['financeiro.pagar','financeiro.cobrancas_ver','financeiro.extractos_ver','financeiro.despesas_ver']) || $sg_fin_mpesa)): ?>
                    <div class="menu-label">TESOURARIA</div>
                    <?php if ($sige_menu_can_any(['financeiro.pagar'])): ?><a href="?page=sige-app&view=financeiro-pagamentos" class="sige-menu-item <?php echo $view == 'financeiro-pagamentos' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> Registar Pagamento</a><?php endif; ?>
                    <?php if ($sg_fin_mpesa): ?><a href="?page=sige-app&view=financeiro-mpesa" class="sige-menu-item <?php echo $view == 'financeiro-mpesa' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg> Pagamentos Móveis<?php echo $sg_beta; ?></a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['financeiro.extractos_ver'])): ?><a href="?page=sige-app&view=financeiro-extratos" class="sige-menu-item <?php echo $view == 'financeiro-extratos' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="12" y2="17"/></svg> Extractos e Caixa</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['financeiro.cobrancas_ver'])): ?><a href="?page=sige-app&view=financeiro-devedores" class="sige-menu-item <?php echo $view == 'financeiro-devedores' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><polyline points="23 18 13.5 8.5 8.5 13.5 1 6"/><polyline points="17 18 23 18 23 12"/></svg> Central de Cobranças</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['financeiro.despesas_ver'])): ?><a href="?page=sige-app&view=financeiro-despesas" class="sige-menu-item <?php echo $view == 'financeiro-despesas' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M2 12h6l3-9 3 18 3-9h5"/></svg> Despesas</a><?php endif; ?>
                <?php endif; ?>

                <!-- 6. SALA DE AULA (ensinar) -->
                <?php if ($ff_academico && ($sige_menu_can_any(['academico.turmas_ver','academico.lancar_notas','academico.pautas_ver']) || (function_exists('sige_presencas_pode_ver') && sige_presencas_pode_ver()))): ?>
                    <div class="menu-label">SALA DE AULA</div>
                    <?php if ($sige_menu_can_any(['academico.turmas_ver'])): ?><a href="?page=sige-app&view=minhas_turmas" class="sige-menu-item <?php echo $view == 'minhas_turmas' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg> Minhas Turmas</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['academico.lancar_notas'])): ?><a href="?page=sige-app&view=notas" class="sige-menu-item <?php echo $view == 'notas' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg> Lançar Notas</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['academico.pautas_ver'])): ?><a href="?page=sige-app&view=pautas" class="sige-menu-item <?php echo $view == 'pautas' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg> Pautas</a><?php endif; ?>
                    <?php if (function_exists('sige_presencas_pode_ver') && sige_presencas_pode_ver()): ?><a href="?page=sige-app&view=presencas" class="sige-menu-item <?php echo $view == 'presencas' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><path d="m9 16 2 2 4-4"/></svg> Presenças</a><?php endif; ?>
                <?php endif; ?>

                <!-- 7. AVALIAÇÃO & DOCUMENTOS (avaliar) -->
                <?php if ($ff_academico && $sige_menu_can_any(['academico.boletins_ver','academico.aprovar_notas','academico.pauta_final_ver','academico.actas_ver','academico.dec_ver'])): ?>
                    <div class="menu-label">AVALIAÇÃO &amp; DOCUMENTOS</div>
                    ...
                    <?php if ($sige_menu_can_any(['academico.aprovar_notas'])): ?><a href="?page=sige-app&view=aprovar_notas" class="sige-menu-item <?php echo $view == 'aprovar_notas' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><polyline points="20 6 9 17 4 12"/></svg> Aprovar Notas</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['academico.pauta_final_ver'])): ?><a href="?page=sige-app&view=pauta_final" class="sige-menu-item <?php echo $view === 'pauta_final' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg> Pauta Final Oficial</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['academico.actas_ver'])): ?><a href="?page=sige-app&view=acta" class="sige-menu-item <?php echo $view === 'acta' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg> Acta do Conselho</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['academico.dec_ver'])): ?><a href="?page=sige-app&view=dec" class="sige-menu-item <?php echo $view === 'dec' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg> DEC Estat&iacute;stico</a><?php endif; ?>
                <?php endif; ?>

                <!-- 8. JARDIM DE INFÂNCIA (regime pré-escolar) -->
                <?php if ($ff_jardim && $mod_jardim_ativo && $sige_menu_can_any(['jardim.diario_ver','jardim.saude_ver','jardim.boletim_ver','jardim.relatorio_ver','jardim.presencas_ver'])): ?>
                    <div class="menu-label">JARDIM DE INFÂNCIA</div>
                    <?php if ($sige_menu_can_any(['jardim.diario_ver'])): ?><a href="?page=sige-app&view=jardim_diario" class="sige-menu-item <?php echo $view=='jardim_diario' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg> Diário de Actividades</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['jardim.presencas_ver'])): ?><a href="?page=sige-app&view=jardim_presencas" class="sige-menu-item <?php echo $view=='jardim_presencas' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg> Presenças</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['jardim.saude_ver'])): ?><a href="?page=sige-app&view=jardim_saude" class="sige-menu-item <?php echo $view=='jardim_saude' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M12 2a5 5 0 0 0-5 5c0 4 5 11 5 11s5-7 5-11a5 5 0 0 0-5-5z"/></svg> Nutrição e Saúde</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['jardim.boletim_ver'])): ?><a href="?page=sige-app&view=jardim_boletim" class="sige-menu-item <?php echo $view=='jardim_boletim' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg> Boletim Pré-Escolar</a><?php endif; ?>
                    <?php if ($sige_menu_can_any(['jardim.relatorio_ver'])): ?><a href="?page=sige-app&view=jardim_relatorio" class="sige-menu-item <?php echo $view=='jardim_relatorio' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg> Diários &amp; Análises</a><?php endif; ?>
                <?php endif; ?>

                <!-- 9. OPERAÇÃO ESCOLAR (operação diária) -->
                <?php
                $sg_op_portaria = $ff_portaria && $sige_menu_can_any(['portaria.ver','portaria.validar_acesso']);
                $sg_op_transporte = $ff_transporte && $mod_transporte_ativo && $sige_menu_can_any(['transporte.ver','transporte.rotas_gerir','transporte.alunos_gerir']);
                ?>
                <?php if ($sg_op_portaria || $sg_op_transporte): ?>
                    <div class="menu-label">OPERAÇÃO ESCOLAR</div>
                    <?php if ($sg_op_portaria): ?><a href="?page=sige-app&view=portaria" class="sige-menu-item <?php echo $view == 'portaria' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> Portaria Digital</a><?php endif; ?>
                    <?php if ($sg_op_transporte): ?><a href="?page=sige-app&view=transporte" class="sige-menu-item <?php echo $view == 'transporte' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M10 17h4V5H2v12h3"/><path d="M20 17h2v-3.34a4 4 0 0 0-1.17-2.83L18 8h-4v9h1"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/></svg> Transporte</a><?php endif; ?>
                <?php endif; ?>

                <!-- 10. COMUNICAÇÃO -->
                <?php if ($sige_menu_can_any(['comunicacao.central_ver','comunicacao.whatsapp_ver','comunicacao.circulares_enviar'])): ?>
                    ...
                    <?php if ($sige_menu_can_any(['comunicacao.circulares_enviar'])): ?><a href="?page=sige-app&view=whatsapp_circulares" class="sige-menu-item <?php echo $view == 'whatsapp_circulares' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="m3 11 18-5v12L3 14v-3z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/></svg> Circulares</a><?php endif; ?>
                <?php endif; ?>

                <!-- 11. RELATÓRIOS & ANÁLISE (acompanhar) -->
                <?php
                $sg_rel_fin = $sg_fin_on && ($sige_menu_can_any(['financeiro.dashboard_ver','financeiro.ver','financeiro.relatorio_mensal_ver','financeiro.pagamentos_turma_ver','financeiro.auditoria_ver']) || $sg_fin_mpesa || $sg_fin_aprov);
                $sg_rel_aca = $ff_academico && $sige_menu_can_any(['academico.auditoria_notas_ver','academico.estatisticas_ver']);
                ?>
                <?php if ($sg_rel_fin || $sg_rel_aca): ?>
                    <div class="menu-label">RELATÓRIOS &amp; ANÁLISE</div>
                    <?php if ($sg_fin_on && $sige_menu_can_any(['financeiro.dashboard_ver','financeiro.ver'])): ?><a href="?page=sige-app&view=financeiro-dashboard" class="sige-menu-item <?php echo $view == 'financeiro-dashboard' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg> Painel Financeiro</a><?php endif; ?>
                    <?php if ($sg_fin_on && $sige_menu_can_any(['financeiro.relatorio_mensal_ver'])): ?><a href="?page=sige-app&view=financeiro-relatorio-mensal" class="sige-menu-item <?php echo $view == 'financeiro-relatorio-mensal' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> Relatório Mensal</a><?php endif; ?>
                    ...
                    <?php if ($sg_fin_mpesa): ?><a href="?page=sige-app&view=financeiro-reconciliacao" class="sige-menu-item <?php echo $view == 'financeiro-reconciliacao' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg> Reconciliação<?php echo $sg_beta; ?></a><?php endif; ?>
                    <?php if ($sg_fin_aprov): ?><a href="?page=sige-app&view=financeiro-aprovacoes" class="sige-menu-item <?php echo $view == 'financeiro-aprovacoes' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg> Aprovações<?php echo $sg_beta; ?></a><?php endif; ?>
                    <?php if ($sg_fin_on && $sige_menu_can_any(['financeiro.auditoria_ver'])): ?><a href="?page=sige-app&view=financeiro-auditoria" class="sige-menu-item <?php echo $view == 'financeiro-auditoria' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg> Auditoria Financeira</a><?php endif; ?>
                    <?php if ($ff_academico && $sige_menu_can_any(['academico.auditoria_notas_ver'])): ?><a href="?page=sige-app&view=auditoria_notas" class="sige-menu-item <?php echo $view == 'auditoria_notas' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> Auditoria de Notas</a><?php endif; ?>
                    <?php if ($ff_academico && $sige_menu_can_any(['academico.estatisticas_ver'])): ?><a href="?page=sige-app&view=estatisticas_demo" class="sige-menu-item <?php echo $view === 'estatisticas_demo' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M18 20V10"/><path d="M12 20V4"/><path d="M6 20v-6"/></svg> Estatísticas da Escola</a><?php endif; ?>
                <?php endif; ?>

                <!-- 12. CONFIGURAÇÃO (suporte) -->
                <?php
                $sg_cfg_fin = $sg_fin_on && $sige_menu_can_any(['financeiro.servicos_ver','financeiro.configurar_precos','financeiro.centros_custo_ver']);
                $sige_pode_permissoes = $sige_menu_can_any(['usuarios.gerir_permissoes']);
                $sg_cfg_sis = $is_core_tech || $sige_pode_permissoes;
                ?>
                <?php if ($sg_cfg_fin || $sg_cfg_sis): ?>
                    <div class="menu-label">CONFIGURAÇÃO</div>
                    <?php if ($sg_fin_on && $sige_menu_can_any(['financeiro.servicos_ver','financeiro.configurar_precos'])): ?><a href="?page=sige-app&view=financeiro-config" class="sige-menu-item <?php echo $view == 'financeiro-config' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg> Preços e Serviços</a><?php endif; ?>
                    <?php if ($sg_fin_on && $sige_menu_can_any(['financeiro.centros_custo_ver'])): ?><a href="?page=sige-app&view=financeiro-centros" class="sige-menu-item <?php echo $view == 'financeiro-centros' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M3 21h18"/><path d="M5 21V7l8-4v18"/><path d="M19 21V11l-6-4"/></svg> Centros de Custo</a><?php endif; ?>
                    <?php if ($is_core_tech): ?><a href="?page=sige-app&view=sige_core_status" class="sige-menu-item <?php echo $view == 'sige_core_status' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg> Saúde do Sistema</a><?php endif; ?>
                    <?php if ($is_core_tech || $sige_pode_permissoes): ?><a href="?page=sige-app&view=sige_permissoes" class="sige-menu-item <?php echo $view == 'sige_permissoes' ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 11l-3 3-2-2"/><path d="M17 14l5-5"/></svg> Perfis e Permissões</a><?php endif; ?>
                    <?php if ($is_core_tech): ?><a href="?page=sige-app&view=config_center" class="sige-menu-item <?php echo in_array($view, ['config_center','config'], true) ? 'active' : ''; ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="sige-u-shrink-0"><path d="M4 4h16v16H4z"/><path d="M9 9h6"/><path d="M9 13h6"/><path d="M9 17h3"/></svg> Centro de Configuração</a><?php endif; ?>
                <?php endif; ?>

                <!-- 13. PRIVACIDADE E DADOS (suporte) -->
                <?php
