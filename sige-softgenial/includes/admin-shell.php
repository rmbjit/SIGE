        ...
        <aside id="sige-sidebar" class="sg-app-sidebar" style="--sg-school-primary: <?php echo esc_attr($escola->cor_primaria ?: 'var(--sg-theme-primary-800,#3b2f8d)'); ?>;">
            ...
            <nav class="sg-app-nav">
                ...
                <?php if ($ff_financeiro && $mod_financeiro_ativo): ?>
                    <?php
                    // v12.19.9 - Tesouraria reorganizada em 3 grupos, cada item gated pela
                    // sua propria permissao (igual ao $sige_view_permission_map). Corrige T1
                    // (menu mostrava itens por can_any do bloco, em desacordo com a rota).
                    ...
                    $sg_grp_tesouraria = $sige_menu_can_any(['financeiro.pagar','financeiro.cobrancas_ver','financeiro.dashboard_ver','financeiro.ver']) || $sg_fin_mpesa || $sg_fin_aprov;
                    $sg_grp_relatorios = $sige_menu_can_any(['financeiro.auditoria_ver','financeiro.pagamentos_turma_ver','financeiro.relatorio_mensal_ver','financeiro.extractos_ver']);
                    $sg_grp_fin_config = $sige_menu_can_any(['financeiro.lancamentos_ver','financeiro.lancamentos_gerir','financeiro.despesas_ver','financeiro.centros_custo_ver','financeiro.lancar_mensalidades','financeiro.planos_ver','financeiro.planos_gerir','financeiro.servicos_ver','financeiro.configurar_precos']);
                    ?>
                    ...
                    <div class="menu-label">FINANÇAS · RELATÓRIOS</div>
