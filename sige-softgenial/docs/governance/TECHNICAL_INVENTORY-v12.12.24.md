# TECHNICAL_INVENTORY - v12.12.24 - MFA de Operacao (Step-up)
...
- Superficie de accao: 198 (sobe de 197). O unico item novo e o endpoint admin_post:sige_privacidade_exportar (exportacao do dossie de dados pessoais). admin_post passa de 39 para 40.
