# PUBLIC ENDPOINTS POLICY - v12.12.10

## endpoint publico
A v12.12.10 nao adiciona nem remove endpoints publicos. O incremento endurece a camada de escrita por tenant; nenhum sumidouro tocado e publico. Os endpoints publicos do manifesto permanecem:
